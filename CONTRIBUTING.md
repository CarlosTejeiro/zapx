...
See [repo_structure.md](repo_structure.md) for the full directory map.

## Coding standards

All code must comply with [style_guide.md](style_guide.md). Read it before writing a line.
